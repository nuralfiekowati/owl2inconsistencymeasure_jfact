...
class MIVshapley_jfact {

	public static void mivshapley_measure(OWLDataFactory df, Set<Set<OWLAxiom>> arrayOfExplanationSet,
			HashSet<OWLAxiom> ontologyAxiomSet) {

		long startTime = System.currentTimeMillis();

		try {
			File file = new File("outputs/output_jfact_MIVshapley_K3.txt");
